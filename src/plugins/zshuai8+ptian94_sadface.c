 ...
 * prints out sad face with given number
...
{
    printf("Plugin 'sadface' initialized...\n");
    return true;
}
...
static bool
sadface (struct esh_command *cmd)
{
    if (strcmp(cmd->argv[0], "sadface"))
        return false;
