...
# no arguments
c.sendline("bcd")
assert c.expect("You have to provide enough inputs.") == 0, \
...
# valid argument
c.sendline("bcd 1 2")
assert c.expect("The biggest common divisor between two input numbers is 1") == 0, \
	"Error: expected output \"You have to put valid inputs inside.\" "

# invalid argument
c.sendline("bcd -1 2")
assert c.expect("You have to put valid inputs inside") == 0, \
	"Error: expected output \"You have to put valid inputs inside.\" "

# valid argument
c.sendline("bcd 100 50")
assert c.expect("The biggest common divisor between two input numbers is 50") == 0, \
	"Error: expected output \"You have to put valid inputs inside.\" "

# invalid argument
c.sendline("bcd 1 2 3")
