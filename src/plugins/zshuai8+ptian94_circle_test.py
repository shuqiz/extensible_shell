...
# no arguments
c.sendline("circle")
assert c.expect("You have to provide valid raduis as an argument.") == 0, \
	"Error: expected output \"You have to put valid inputs inside.\" "
# invalid argument
c.sendline("circle -3")
assert c.expect("Invalid raduis, please provide with a valid input") == 0, \
"Error: expected output \"You have to put valid inputs inside.\" "

# valid argument
c.sendline("circle 1")
assert c.expect("The circle area = 3.14 , The circle circumference = 6.28") == 0, \
	"Error: expected output \"You have to put valid inputs inside.\" "

# invalid argument
c.sendline("circle -1 2 3")
